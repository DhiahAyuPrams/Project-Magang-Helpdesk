    ...
    <body>
        <div class="login">
            ...
            <div class="login-container">
                <p style="text-align: center;"><strong>Register Here!</strong></p>
            <p>
            ...
            <p style="text-align: center; font-size: 12px;">
                <label for="akun">Already have an account? <a href={{ route('login') }} style="color: blue;">Login</a></label>
            </p>
            <p>
