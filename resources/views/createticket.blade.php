...
<body class="hold-transition sidebar-mini layout-fixed">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="/create-ticket" class="nav-link active">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/ticket-list">Tickets List</a></li>
                ...
                <div class="container-fluid">
                    <div style="display: flex; justify-content: center;">
                        <div class="card col-11 p-4">
                            <form action="/tambah-ticket-admin" method="POST">
                                @csrf
                            <div class="row" style="display: flex; justify-content: center;">
                                <!-- left column -->
                                <div class="col-4">
                                    <h3 class="col-12" style="margin-bottom: 0;">Ticket Detail</h3>
                                    <p class="col-12" style="margin-top: 0; opacity: 0.5;">Ticket Details and Classification</p>
                                </div>
                                <!--/.col (left) -->
                                <!-- right column -->
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control application" id="aplikasi" name="aplikasi" onchange="hideAppPlaceholder()">
                                            <option value="--placeholderApp">-- Select Application --</option>
                                            <option Value="INSLOPE (Sistem Manajemen Lereng Jalan)">INSLOPE (Sistem Manajemen Lereng Jalan)</option>
                                            <option Value="SMD (Sistem Masukan Data)">SMD (Sistem Masukan Data)</option>
                                            <option value="SIDAKO-POK">SIDAKO-POK</option>
                                        </select>
                                    </div> 
                                    <div class="form-group">
                                        <label>Subject</label>
                                        <input type="text" id="subjek" name="subjek" class="form-control" placeholder="Insert Subject">
                                    </div>  
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control priority" id="prioritas" name="prioritas" onchange="hidePrioPlaceholder()">
                                            <option value="--placeholderPrio">-- Select Priority --</option>
    ...
    <script>
        ...
        function hidePrioPlaceholder() {
            var placeholderOption = document.querySelector('.form-control.priority option[value="--placeholderPrio"]');
            if (placeholderOption) {
                placeholderOption.remove();
            }
        }
