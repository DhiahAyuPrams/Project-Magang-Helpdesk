                ...
                <div class="container-fluid d-flex justify-content-center">
                    <div class="col-12 card p-4">
                        <div class="ml-auto d-flex justify-content-start">
                            <a href="/create-user" class="btn btn-primary mr-1 mb-3"><i
                                    class=" fas fa-solid fa-plus"></i> Add User</a>
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 mb-4"> 
                                <div class="card card-widget widget-user">
                                    <!-- Header -->
                                    <div class="widget-user-header bg-warning text-center" style="padding: 15px;">
                                        <!-- Nama User -->
                                        <h5 class="widget-user-username" style="font-size: 16px; margin-bottom: 5px;">
                                            {{ $item->name }}</h5>
                                        <!-- Role User -->
                                        <h5 class="widget-user-desc" style="font-size: 16px; margin-top: 0;">
                                            {{ $item->role }}</h5>
                                    </div>

                                    <!-- Profile Icon -->
                                    <div class="widget-user-image text-center" style="margin-top: -5px;">
                                        <i class="fas fa-user-circle"
                                            style="font-size: 80px; color: #ffffff; border: 3px solid white; border-radius: 50%; background-color: #ffc107; padding: 5px;"></i>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row d-flex justify-content-between">
                                            ...
                                            <div class="col-sm-6 border-right">
                                                <button type="button" class="btn btn-block btn-info editUserBtn"
                                            ...
                                            <div class="col-sm-6">
                                                <button type="button" class="btn btn-block btn-danger deleteUserBtn"
    ...
    <script>
        $(document).ready(function() {
            $('.deleteUserBtn').click(function() {
                ...
                var deleteUrl = "{{ route('user.destroy', ':id') }}".replace(':id', userId);
